...
updatedOn: '2023-03-07'
summary: 'We should praise, not condemn, tech companies'
---

Americans hate successful businesses. We verbally assault technology companies more than any other group.
...
Recent studies by the Pew Research Center highlight just how hostile we are. According to [data](https://www.pewresearch.org/fact-tank/2020/10/27/how-americans-see-u-s-tech-companies-as-government-scrutiny-increases/) from 2020:
...
<CalloutWithLabel title='What we will discuss'>
- Americans hate successful people and companies
- Specific examples from political and cultural leaders
- Tech companies make modern life possible
- We should praise these corporations, not attack them
</CalloutWithLabel>
...
<div className="border-2 border-gray-700 bg-gray-50 p-6 rounded text-sm">
...
<span className='font-semibold py-[0.15em] px-1 rounded bg-pastelBlueHover'>Initiating force is always wrong, regardless of context.</span>
...
<InfoCalloutWithLabel title='✋ Hey, why did you put "monopoly" in quotes?' type='info'>
  ...
  - FaceTime™️ a friend on the other side of the world in HD quality
